...
contenido_readme = """# Solvencia bancaria en el Perú: ratio de capital global y activos ponderados por riesgo
...
# Detecta la carpeta base (un nivel arriba de /codigo)
try:
    DIR_ACTUAL = os.path.dirname(os.path.abspath(__file__))
except NameError:
    DIR_ACTUAL = os.getcwd()

DIR_BASE = os.path.dirname(DIR_ACTUAL) if os.path.basename(DIR_ACTUAL).lower() == "codigo" else DIR_ACTUAL
